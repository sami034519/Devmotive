...
const CompanyStats = () => {
  return (
    <section className="bg-white lg:py-2 lg:pb-16 pb-5 px-4">
      <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 text-center"  data-aos="fade-up">
        {stats.map((stat, index) => (
          <div key={index} className="p-4 bg-gradient-to-tr from-white to-red-100 rounded-lg">
