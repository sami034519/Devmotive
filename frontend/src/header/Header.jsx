        ...
        >
          ...
          <div className="flex items-center space-x-3">
            <a
              ...
              className="hover:bg-blue-500 border-2 hover:rounded-full text-base border-white p-1 rounded-lg"
            >
              <FaFacebookF />
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:bg-blue-400 border-2 hover:rounded-full border-white p-1 text-base rounded-lg"
            >
              <FaTwitter />
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:bg-red-500 border-2 hover:rounded-full border-white p-1 text-base rounded-lg"
            >
              <FcGoogle />
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:bg-blue-600 border-2 hover:rounded-full border-white p-1 text-base rounded-lg"
            >
              <FaLinkedinIn />
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:bg-green-500 hover:rounded-full border-2 border-white p-1 text-base rounded-lg"
            >
              <FaWhatsapp />
            </a>
