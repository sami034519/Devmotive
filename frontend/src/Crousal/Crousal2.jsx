  ...
  return (
    <div className="relative lg:h-[80vh] w-full overflow-hidden z-30">
      ...
      <div className="absolute inset-0 flex items-center justify-around lg:px-12 px-1">
        ...
        >
          <h1 className={`lg:text-[70px] text-xl font-semibold text-red-600 whitespace-nowrap ${
            animate ? 'animate__animated animate__fadeInDownBig animate__delay-1s' : ''
          }`}>
            Mobile App Development
          </h1>

          <h1 className={`lg:text-[60px] text-lg font-semibold text-black whitespace-nowrap lg:mt-28 lg:mb-10 mt-2 mb-2 ${
