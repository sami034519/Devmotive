     ...
     {/* buttons */}
      ...
      <div className="flex gap-2 lg:gap-4 justify-center mb-8 ">
        ...
        <button
          ...
          className={`flex items-center gap-x-2 px-1 py-3 lg:gap-2 lg:px-6 lg:text-lg text-xs lg:py-3 rounded transition shadow-lg shadow-slate-400  hover:shadow-lg hover:shadow-red-500  ${
        ...
        <button
          ...
          className={`flex items-center gap-x-2 px-1 py-3 text-xs lg:gap-2 lg:px-6 lg:text-lg lg:py-3 rounded transition shadow-lg shadow-slate-400  hover:shadow-lg hover:shadow-red-500   ${
            activeComponent === "app"
              ? "bg-red-600 text-white "
