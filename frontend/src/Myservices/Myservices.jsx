    ...
    subServices: [
      {
        ...
        description: "Modern web and mobile apps tailored to your business goals."
      },
      {
      ...
      },
      {
        ...
        description: "Streamline operations by integrating and automating systems."
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subServices: [
      ...
      },
      {
        ...
        description: "Deploy containers for efficient and portable applications."
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subServices: [
      ...
      },
      {
        ...
        description: "Get expert advice tailored for small and medium businesses."
      },
      {
...
function Myservices() {
 const clients = [
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="relative w-full lg:h-[80vh] h-[300px] overflow-hidden mt-16">
        <img
          loading="lazy"
          src={background}
          alt="Services"
        ...
        <div key={index} className="mb-16">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {section.subServices.map((sub, idx) => (
              <Link
                key={idx}
                to={`/services/${sub.name.toLowerCase().replace(/[\s()/]+/g, "-")}`}
                data-aos="fade-up"
